              ...
              <div className="absolute right-0 mt-6 w-60 max-w-[calc(100vw-2rem)] bg-mkhe-input border border-mkhe-border rounded-lg shadow-xl py-2 z-50 origin-top-right text-mkhe-text">
                ...
                {activeMenu === "admin_content" && (
                  <div>
                    ...
                    <Link to="/admin/policies" onClick={() => setIsDropdownOpen(false)}
                      className={`mx-2 px-3 py-2 rounded-md text-sm cursor-pointer transition-colors flex items-center gap-3 ${location.pathname.startsWith("/admin/policies") ? "text-mkhe-primary hover:bg-mkhe-primary/10" : "opacity-80 hover:opacity-100 hover:bg-mkhe-primary/10"}`}>
                      <HelpCircle className="w-4 h-4" /> Chính sách & FAQ
                    </Link>
