  ...
  return (
    <div className="flex flex-1 overflow-hidden">
      <div className="hidden lg:flex lg:w-1/2 relative bg-mkhe-bg items-center justify-center border-r border-mkhe-border/30 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-mkhe-bg via-mkhe-bg/60 to-transparent z-10" />
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-mkhe-bg">
        <LoginForm />
      </div>
    </div>
  );
