              ...
              orders.map((order) => (
                <tr key={order._id} className="border-b border-mkhe-border/50 hover:bg-mkhe-primary/5 transition-colors last:border-b-0">
                  ...
                  <td className="px-4 py-2.5">
                    <div className="text-mkhe-text/80 font-medium">{new Date(order.createdAt).toLocaleDateString("vi-VN")}</div>
                    <div className="text-xs text-mkhe-text/50 mt-0.5">{new Date(order.createdAt).toLocaleTimeString("vi-VN", { hour: '2-digit', minute: '2-digit' })}</div>
                  </td>
                  <td className="px-4 py-2.5">
