              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  <div 
                    ...
                    dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(product.story || product.description, { ADD_TAGS: ['iframe'], ADD_ATTR: ['allow', 'allowfullscreen', 'frameborder', 'scrolling'] }) }}
                  />
