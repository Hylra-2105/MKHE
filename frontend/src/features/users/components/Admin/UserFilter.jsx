    ...
    <div className="bg-mkhe-bg p-3 md:p-4 rounded shadow mb-6 flex flex-col md:flex-row md:items-center gap-4 border border-mkhe-border/30">
      ...
      <div className="relative w-full md:w-80" ref={dropdownRef}>
        <button
          ...
          type="button"
          className="w-full h-10 px-3 bg-transparent border border-mkhe-border/50 text-mkhe-text cursor-pointer rounded focus:outline-none focus:border-mkhe-primary transition-colors flex justify-between items-center hover:border-mkhe-border"
        >
        ...
        {isDropdownOpen && (
          <div className="absolute right-0 top-full mt-1 w-full bg-mkhe-input border border-mkhe-border rounded-lg shadow-xl py-2 z-50">
            <button
              onClick={() => {
